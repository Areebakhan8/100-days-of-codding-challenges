...
let transport:string[] =["Honda Motorcycle","corolla Car","civic"]
...
let Guests:string[]=["Khadija","Amna","Tasmiya", "Rameen"]
...
let guestArray:string[] =["Khadija", "Amna", "Tasmiya", "Rameeen"]
let cannotattend:string="Rameen"
console.log("Answer15:")
console.log(cannotattend + "can not attend the dinner toinght")//cant make dinner


let newGuest:string=("Hassan")//replace the guest
