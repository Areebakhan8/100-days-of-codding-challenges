...
let guestList = ["Mehak", "Areeba", "Bilal", "Hamza", "Ameen"];
...
guestList.forEach(guestList => { console.log(`dear ${guestList} would you like to celebrate my success?`); });
//Question17:
...
let placeTovisit = ["Pakistan", "Dubai", "SaudiArabia", "America", "London"];
